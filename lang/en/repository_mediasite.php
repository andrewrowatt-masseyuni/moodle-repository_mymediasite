...
$string['information'] = 'Your Mediasite administrator, host or provider will need to provide these credentials.';
$string['manageurl'] = 'Management URL';
$string['manageurl_help'] = 'This optional link will be displayed in the File Picker. Typically it will be to the My Mediasite area.';
